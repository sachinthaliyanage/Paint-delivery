      ...
      <h1 className="text-4xl font-bold text-center text-slate-800 mb-6">&quot;The advancement of route and <br /> schedule optimization&quot;</h1>
        ...
        <div className="flex flex-row">
            <Card 
                ...
                para="A native app for both iOS and Android devices manages comprehensive route details, order information, and navigation directly on the driver’s smartphone. Route updates and order statuses are instantly accessible, ensuring real-time information is always at hand." 
            />
            <Card 
